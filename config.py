...
train_arg.add_argument('--feature', type=str, default = "V1",
...
train_arg.add_argument('--hidden_dim', type=int, default = 64)
train_arg.add_argument('--latent_dim', type=int, default = 32)
